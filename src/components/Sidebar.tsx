  ...
  return (
    ...
    >
      <div>
        <div className="sidebar-header">
          <div className="sidebar-header-title">
            <span
              className="sidebar-header-pulse"
              style={{
                background: "#ff9933",
                boxShadow:
                  "0 0 8px #ff9933",
      ...
      <div className="sidebar-footer">
        <div
          className="sidebar-security-badge"
          style={{
            borderColor:
              "rgba(0, 255, 157, 0.3)",
            background:
        ...
        >
          ...
          <div className="sidebar-security-text">
            <span className="sidebar-security-title">
              28 STATE CYBER CELLS
            </span>

            <span className="sidebar-security-desc">
              CERT-In 6-Hr Rule Active
            </span>
          </div>
        </div>
        ...
        <div className="sidebar-system-telemetry">
          <div className="sidebar-telemetry-item">
            ...
            <span
              className="sidebar-telemetry-val"
              style={{
                color:
                  "var(--status-green)",
              }}
          ...
          <div className="sidebar-telemetry-item">
            ...
            <span className="sidebar-telemetry-val">
              MANDATED
            </span>
          </div>
        </div>
